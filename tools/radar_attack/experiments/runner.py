...
SUMMARY_COLUMNS = (
    ...
    'reference_region_points',
    'reference_region_A_p95',
    'reference_region_A_max',
    'reference_region_R_joint95',
    'reference_region_R_joint99',
    'migration_target_current_total_points',
    'migration_target_current_N_modified',
    'migration_target_current_mean_l2_m',
    'migration_target_current_p95_l2_m',
    'migration_target_current_max_l2_m',
    'migration_target_current_sum_l2_m',
    'migration_target_current_N_gt_1cm',
    'migration_target_current_fraction_gt_1cm',
    'migration_target_current_N_gt_5cm',
    'migration_target_current_fraction_gt_5cm',
    'migration_target_current_N_gt_10cm',
    'migration_target_current_fraction_gt_10cm',
    'migration_target_history_total_points',
    'migration_target_history_N_modified',
    'migration_target_history_mean_l2_m',
    'migration_target_history_p95_l2_m',
    'migration_target_history_max_l2_m',
    'migration_target_history_sum_l2_m',
    'migration_target_history_N_gt_1cm',
    'migration_target_history_fraction_gt_1cm',
    'migration_target_history_N_gt_5cm',
    'migration_target_history_fraction_gt_5cm',
    'migration_target_history_N_gt_10cm',
    'migration_target_history_fraction_gt_10cm',
    'migration_non_target_background_total_points',
    'migration_non_target_background_N_modified',
    'migration_non_target_background_mean_l2_m',
    'migration_non_target_background_p95_l2_m',
    'migration_non_target_background_max_l2_m',
    'migration_non_target_background_sum_l2_m',
    'migration_non_target_background_N_gt_1cm',
    'migration_non_target_background_fraction_gt_1cm',
    'migration_non_target_background_N_gt_5cm',
    'migration_non_target_background_fraction_gt_5cm',
    'migration_non_target_background_N_gt_10cm',
    'migration_non_target_background_fraction_gt_10cm',
    ...
    row = {
        ...
        **{
            ...
            for field in (
                ...
                'max_l2_m', 'sum_l2_m',
                'N_gt_1cm', 'fraction_gt_1cm',
                'N_gt_5cm', 'fraction_gt_5cm',
                'N_gt_10cm', 'fraction_gt_10cm',
            )
        },
